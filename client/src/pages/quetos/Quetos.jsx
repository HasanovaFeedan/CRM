          ...
          <Box sx={{ ...style, position: "relative" }}>
            ...
            <div className="flex-op">
              <div className="left-op">
                ...
                <div className={!direction ? "disabled-section" : "transport-section"}>
                  <p>Transport:</p>
                  <label htmlFor="air">
                    <input
                      type="checkbox"
                      ...
                      onChange={() => direction && handleTransportChange("air")}
                      disabled={!direction}
                    />
                    <span>Air</span>
                    <img src={transport === "air" && direction ? "/image/dord.png" : "/image/airnocolor.png"} alt="" />
                  </label>
                  <label htmlFor="ocean">
                    <input
                      type="checkbox"
                      ...
                      onChange={() => direction && handleTransportChange("ocean")}
                      disabled={!direction}
                    />
                    <span>Ocean</span>
                    <img src={transport === "ocean" && direction ? "/image/oceancolor.png" : "/image/bes.png"} alt="" />
                  </label>
                  <label htmlFor="inland">
                    <input
                      ...
                      onChange={() => direction && handleTransportChange("inland")}
                      disabled={!direction}
                    />
                    <span>Inland</span>
              ...
              <div className={`right-op ${!direction ? "disabled-section" : ""}`}>
                <div className="one-input-op">
                  <div className="op-side">
                    <label>Shipper</label>
                    <div className="op-f">
                      <input className="op-inp" type="text" placeholder="Enter name" disabled={!direction} />
                      <span>+</span>
                  ...
                  <div className="option-group">
                    <label className={`option ${selectedRate === "spot" ? "selected" : ""}`}>
                      <input
                        ...
                        onChange={() => direction && setSelectedRate("spot")}
                        disabled={!direction}
                      />
                    ...
                    <label className={`option ${selectedRate === "rounding" ? "selected" : ""}`}>
                      <input
                        ...
                        onChange={() => direction && setSelectedRate("rounding")}
                        disabled={!direction}
                      />
                ...
                {selectedRate === "rounding" && direction && (
                  <div className="direction-f">
                    <div className="flex-date-div">
                      <div className="flex-da">
                        <p className="p-d">
                          Start date: <span className="zero">aaaaa</span>
                        </p>
                        <div className="calendar-div">
                          <span>{startDate.toLocaleDateString("tr-TR")}</span>
                          <FaCalendarDays className="i" onClick={() => datePickerRef.current?.setOpen(true)} />
                          <DatePicker
                            selected={startDate}
                        ...
                        <div className="clock-div">
                          ...
                          <FaClock className="i" onClick={() => timePickerRef.current?.setOpen(true)} />
                          <DatePicker
                            selected={startTime}
                ...
                {/* Rest of the form - always visible but disabled when no direction */}
                <div className="second-input-op">
                  ...
                  <div className="op-side">
                    {transport === "ocean" && direction ? (
                      ...
                      <div className="op-f">
                        <input className="op-inp" type="text" placeholder="Airline" disabled={!direction} />
                        <IoSearch className="seric" />
                      </div>
                    )}
                    <div className="emp-op"></div>
                    ...
                    {/* Continue with rest of form fields - all with disabled={!direction} */}
                    <div className="one-input-op">
                      <div className="op-side">
                        <label>General</label>
                        <div className="op-f">
                      ...
                      <div className="op-side">
                        <div className="flex-opss">
                          <p>Freight P/C:</p>
                          <div className="op-fs">
                            <select className="op-inps" disabled={!direction}>
                    ...
                    {/* Expected Order Details section */}
                    <div className="one-input-op">
                      {transport === "ocean" && direction ? (
                      ...
                      <div className="op-side">
                        ...
                        <label htmlFor="" style={{ display: "flex", gap: "10px" }}>
                          <input type="checkbox" id="danger" disabled={!direction} />
