...
import { FaPlane, FaDownload, FaSearch, FaPlus } from 'react-icons/fa'; 
...
const OperationDetail = () => {
  return (
    <div className="dashboard-main-box">
            ...
            <h2>Operations <span>> Single Operation</span></h2>
...
<div className="white-sec">
      ...
      <main className="operation-main-content">
        <section className="info-section cargo-info">
          ...
          <div className="cargo-content-wrapper"> {/* New wrapper */}
            <div className="shipment-details"> {/* Wrapper for info-grid and its title if any */}
              <h4>Shipment</h4>
