    ...
    <div className="dashboard-main-box">
      <div className="dashboard-header-client">
        ...
        <div className="dashboard-header-right-client">
          ...
          <button className="new-opera" onClick={handleOpen}>
      ...
      <div className="doc-wrappersa">
        <div className="jus">
          ...
          <div className="flex-last">
            <div className="doc-headersa">
              <button className={`gr ${filter === "All" ? "active" : ""}`} onClick={() => setFilter("All")}>
                All
              </button>
              <button className={`gr ${filter === "ucakmavi" ? "active" : ""}`} onClick={() => setFilter("ucakmavi")}>
                <img src="/image/grayfly.png" alt="" />
              </button>
              <button className={`gr ${filter === "gemimavi" ? "active" : ""}`} onClick={() => setFilter("gemimavi")}>
                <img src="/image/gemigray.png" alt="" />
              </button>
              <button className={`gr ${filter === "busmavi" ? "active" : ""}`} onClick={() => setFilter("busmavi")}>
                <img src="/image/busgray.png" alt="" />
              </button>
              <button className={`gr ${filter === "trainmavi" ? "active" : ""}`} onClick={() => setFilter("trainmavi")}>
                <img className="train" src="/image/traingray.png" alt="" />
              </button>
              <button className={`gr ${filter === "sekilmavi" ? "active" : ""}`} onClick={() => setFilter("sekilmavi")}>
        ...
        <div className="table-containersss">
          <div className="table-rows table-headsa">
            ...
            <div className="colaa type" style={{ cursor: "pointer" }}>
          ...
          <div className="table-bodysa">
            {sortedDocuments.map((doc, idx) => (
              <div className="table-rowsa" key={idx} onClick={() => navigate(`/operation/detail/${idx + 1}`)}>
                <div className="colaa type">{doc.type}</div>
                <div className="colaa type">
                  <img src={`/image/${doc.docimage}.png`} alt={doc.docimage} height={20} />
                </div>
                <div className="colaa type">
                  <img src={`/image/${doc.arrowimage}.png`} alt={doc.arrowimage} height={20} />
                </div>
          ...
          <Fade in={open}>
            <Box sx={{ ...style, position: "relative" }}>
              ...
              <div className="flex-op">
                <div className="left-op">
                  ...
                  {["export", "import", "domestic"].map((dir) => (
                    <label htmlFor={dir} key={dir}>
                      <input type="checkbox" id={dir} checked={direction === dir} onChange={() => setDirection(dir)} />
                      <span>{dir.charAt(0).toUpperCase() + dir.slice(1)}</span>
                      <img src={`/image/${dir === "export" ? "bir.png" : "exportnocolor.png"}`} alt={dir} />
                    </label>
                  ))}

                  {/* Transport section - always visible but disabled when no direction */}
                  <div className={!direction ? "disabled-section" : ""}>
                    <p>Transport:</p>
                    {["air", "ocean", "inland"].map((trans) => (
                      <label htmlFor={trans} key={trans}>
                        <input
                          ...
                          onChange={() => direction && setTransport(trans)}
                          disabled={!direction}
                        />
                        <span>{trans.charAt(0).toUpperCase() + trans.slice(1)}</span>
                        <img
                          src={
                            transport === trans && direction
                    ...
                    {/* Ocean shipment type - always visible but disabled */}
                    {transport === "ocean" && (
                      <div>
                        <p>Shipment Type:</p>
                        {["FCL", "LCL"].map((type) => (
                          <label htmlFor={type} key={type}>
                            <input
                              ...
                              onChange={() => direction && setShipmentType(type)}
                              disabled={!direction}
                            />
                            <span>{type}</span>
                          </label>
                ...
                {/* Right section - always visible but disabled when no direction */}
                <div className={`right-op ${!direction ? "disabled-section" : ""}`}>
                  <div className="one-input-op">
                    {["Shipper", "Consignee"].map((label) => (
                      <div className="op-side" key={label}>
                        <label>{label}</label>
                        <div className="op-f">
                          <input className="op-inp" type="text" placeholder="" disabled={!direction} />
                          <span>+</span>
                  ...
                  <div className="one-input-op">
                    <div className="op-side">
                      ...
                      <div className="op-f">
                        <select className="op-inp" disabled={!direction}>
                  ...
                  <div className="pic-drc">
                    ...
                    <label htmlFor="pickup">
                      <input type="checkbox" id="pickup" disabled={!direction} />
                  ...
                  <div className="pic-drc">
                    ...
                    <label htmlFor="delivery">
                      <input type="checkbox" id="delivery" disabled={!direction} />
                      <span>Include Delivre</span>
                    </label>
                  </div>

                  <div className="one-input-op">
                    {transport === "ocean" && direction ? (
                      ...
                      <div className="op-side">
                        ...
                        <div className="op-f">
                          <input className="op-inp" type="text" placeholder={"Volume (CBM)"} disabled={!direction} />
                        </div>
                        <div className="op-f">
                          <input
                            className="op-inp"
                  ...
                  <div className="one-input-op">
                    <div className="op-side">
                      ...
                      <div className="op-f">
                        <input className="op-inp" type="text" placeholder={"Agent"} disabled={!direction} />
                        <IoSearch />
                      </div>
                      <div className="op-f">
                        <input className="op-inp" type="text" placeholder={"Reference1"} disabled={!direction} />
                      </div>
                      <div className="op-f">
                        <input className="op-inp" type="text" placeholder={"Reference2"} disabled={!direction} />
                      </div>
                    </div>
                    <div className="op-side">
                      <p className="opzero">My Customer</p>
                      <div className="op-f">
                        <input className="op-inp" type="text" placeholder={"Main Harmonizet"} disabled={!direction} />
                      </div>
                      <div className="op-f">
                        <input className="op-inp" type="text" placeholder={"Shipment Mode"} disabled={!direction} />
                      </div>
                      <div className="op-f">
                        <input className="op-inp" type="text" placeholder={"Tracking Number"} disabled={!direction} />
                      </div>
                    </div>
                  </div>
                  <div className="op-side">
                    <p className="opzero">My Customer</p>
                    <div className="op-fa">
                      <input className="op-inpa" type="text" placeholder={"Notes"} disabled={!direction} />
                    </div>
                  </div>
                </div>
              </div>
              <button className="crt-op" disabled={!direction}>
                Create
              </button>
            </Box>
          </Fade>
